...
const StyledLink = styled.a<StyleProps>`
  ...
  &:visited {
    ...
    color: ${props =>
      props.variant === 'primaryButton' ? props.theme.colors.light[0] : props.primaryColor};
    border: ${props => (props.variant === 'link' ? 0 : '2px solid ' + props.primaryColor)};
    text-decoration: ${props => (props.variant === 'link' ? 'underline' : 'none')};
    padding: ${props => (props.variant === 'link' ? 0 : '0.8rem 1.6rem')};
    text-transform: ${props => (props.variant === 'link' ? 'none' : 'uppercase')};
  ...
  &:active {
    color: ${props =>
      props.variant === 'link' ? alterColor(props.primaryColor, -25) : props.theme.colors.light[0]};
    background-color: ${getHoverBackgroundColor};
    border-color: ${props =>
      props.variant === 'primaryButton' ? alterColor(props.primaryColor, -25) : props.primaryColor};
  }
`;
